  ...
  return (
    <>
      ...
      <div className="portfolio">
        ...
        {/* Floating Circle Menu - Always visible, transforms when menu is open */}
        <div className="floating-menu visible">
          <button className="floating-menu-button" onClick={toggleMenu}>
            <span className="floating-hamburger">
  <span></span>
  <span></span>
</span>
          </button>
...
// Keep all your existing components (HomeSection, WorkSection, AboutSection, ContactSection) exactly the same...
...
const styles = `
  * {
  ...
  /* Floating Circle Menu - Always visible */
  .floating-menu {
    position: fixed;
    top: 2rem;
    right: 2rem;
